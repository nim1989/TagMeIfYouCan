...
if !graph.has_triple?([RDF::URI.new("http://www.facebook.com/834118723"), RDF.type, RDF::FOAF.person])
  graph << [:hello, RDF::FOAF.like, "lazdagal"]  
end
## Same director
query = RDF::Query.new do
  pattern [RDF::URI.new("http://www.facebook.com/834118723"), RDF.type, RDF::FOAF.person]
end

friends = []
solutions = query.execute(graph)
solutions.each do |solution|
  puts solution.friend_of_friend.to_s
end
